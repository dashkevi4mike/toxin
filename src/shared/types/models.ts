...
export type SubLink = { title: string; href: string; };
export type Link = { title: string; href: string; links?: SubLink[]};
export type FooterLinksGroup = { title: string; links: Link[]; mobileInvisible: boolean; }